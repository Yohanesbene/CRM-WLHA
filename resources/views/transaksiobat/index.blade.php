        ...
        <div class="col-12">
            <div class="card mt-4">
                <div class="row">
                    <div class="col-8">
                        <div class="card-body">
                            <h5 class="card-title fs-1">Daftar Transaksi</h5>
                        </div>
                    </div>
                    <div class="col-4">
        ...
        <div class="col">
            ...
            <div class="form-group">
                <div class="input-group my-2">
                    <input type="text" name="searchKeterangan" id="searchKeterangan" class="form-control fs-2" placeholder="Cari Nama Obat / Keterangan" />
