            ...
            <div class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 px-6 py-10 sm:px-10 sm:py-6 bg-white rounded-lg shadow-md lg:shadow-lg">
                ...
                <div class="mb-4">
                    <form class="" action="{{ route('auth.login.proses')}}" method="post">
                        ...
                        <input class="block w-full py-3 px-1 mt-2 text-gray-800 appearance-none border-b-2 border-gray-100 focus:text-gray-500 focus:outline-none focus:border-green-200" type="text" name="username" placeholder="Username" value="{{ old('username') }}" autofocus autocomplete="off">

                        <label class="block text-sm font-semibold text-gray-600 uppercase mt-4" for="password">Password</label>
                        <input class="block w-full py-3 px-1 mt-2 text-gray-800 appearance-none border-b-2 border-gray-100 focus:text-gray-500 focus:outline-none focus:border-green-200" type="password" name="password" placeholder="Password" value="{{ old('password') }}" autofocus autocomplete="off">
