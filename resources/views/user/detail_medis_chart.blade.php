<div class="m-3 flex gap-0">
    <input
        ...
        class=" z-10 border border-indigo-200 border-r-0 rounded-l-lg p-3 text-lg"
        value={{ $date[0] }}>
    <span class="z-0 inline-block border border-indigo-200 border-l-0 border-r-0 bg-gray-200 p-3 text-lg">Sampai</span>
    <input type="date" name="untilDate" id="untilDate"
        class="z-10 border border-indigo-200 border-l-0 rounded-r-lg p-3 text-lg"
        value={{ $date[1] }}>
</div>
<div id="chart" class="h-96 relative">
