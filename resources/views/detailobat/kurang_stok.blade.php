    ...
    <div class="row fs-3">
        ...
        <form class="needs-validation" action="{{url('/simpan_stok')}}" method="post" novalidate>
            ...
            <div class="mb-3">
                ...
                <input {{($edit) ? "value=$keterangan" : ""}} type="text" class="form-control fs-3" placeholder="Pembelian obat oleh pasien (klik disini)" name="keterangan" id="keterangan" aria-describedby="keteranganHelp" required>
            ...
            <div class="mb-3">
                <label for="stokobat" class="form-label fs-3">Jumlah stok yang dikurangkan :</label>
