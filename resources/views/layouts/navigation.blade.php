<div class="flex h-screen">
    <!-- START: Side Navbar -->
    <div class="flex flex-col justify-between w-96 py-6 px-4 static">
        <div class="flex flex-col space-y-4">
            ...
            @if (Session::get('auth_wlha.0.id_level') == 1)
                <a href="{{ url('/admin/kepegawaian') }}"
                    class="flex mt-4 p-4 items-center bg-indigo-600 rounded-md space-x-4 text-white font-semibold text-lg hover:text-indigo-600 transition duration-200">
    ...
    <!-- END: Side Navbar -->
    <div class="flex-auto bg-indigo-50 overflow-y-auto">
        {{ $slot }}
    </div>
</div>
