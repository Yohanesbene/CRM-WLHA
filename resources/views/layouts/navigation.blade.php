<div class="flex md:hidden" id="mobile-navbar">
...
<div class="flex h-full">
    ...
    <div class="hidden md:flex h-full flex-col justify-between w-screen md:w-72 py-6 px-4 sticky-top-0 overflow-y-auto" id="vertical-navbar">
        <div class="flex flex-col space-y-1">
            <div class="hidden md:block items-center justify-center border-b-2 pb-4">
                <h1 class="text-2xl font-bold uppercase text-center text-indigo-500 tracking-wide">ASKEP</h1>
            </div>
            <a href="{{ route('pegawai.index') }}"
                class="flex mt-1 p-2 items-center space-x-4 font-semibold text-lg rounded-md border-2 transition duration-200
                @if (in_array('kepegawaian', $routes_name)) {{ 'bg-indigo-600 text-white border-indigo-600' }}
                @else
            ...
            <a href="{{ url('/daftar_obat') }}"
                class="flex mt-1 p-2 items-center space-x-4 font-semibold text-lg rounded-md border-2 transition duration-200
                @if (in_array('daftar_obat', $routes_name)) {{ 'bg-indigo-600 text-white border-indigo-600' }}
                @else
                    {{ 'bg-white border-white text-gray-400 hover:text-indigo-600 hover:border-indigo-600' }} @endif
                ">
                <svg class="w-6 h-6 mr-4" fill="none"
    ...
    <!-- END: Side Navbar -->
    <div class="flex md:flex w-full h-full bg-indigo-50 overflow-y-auto" id='content'>
        {{ $slot }}
    </div>
