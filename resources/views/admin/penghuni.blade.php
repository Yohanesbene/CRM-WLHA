        ...
        <div class="flex-auto bg-indigo-50 py-6 px-10">
            ...
            <div class="block p-8 bg-white rounded-md">
                ...
                <div class="flex justify-between">
                    ...
                    <button class=" flex bg-indigo-400 px-4 py-2 rounded-md text-white font-semibold shadow-md items-center hover:bg-indigo-600 transition duration-200" @click="modalAddPenghuni = true">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td class="flex py-3 px-6">
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <button class="text-indigo-400 font-medium text-lg hover:text-indigo-900 transition duration-200" @click="modalEditPenghuni = true" id="edit" data-id="{{ $u->id }}">Edit</button>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $i += 1; ?>
