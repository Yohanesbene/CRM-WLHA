<x-app-admin-layout>
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td class="flex py-3 px-6">
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <button class="text-indigo-400 font-medium text-lg hover:text-indigo-900 transition duration-200" @click="modalEditUser = true" id="edit" data-id="{{$u->id}}">Edit</button>
                                                    <button class="text-indigo-400 font-medium text-lg hover:text-indigo-900 transition duration-200" @click="modalGantiPassword = true" id="ubahPassword" data-id="{{$u->id}}">Ubah Password</button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php $i+=1?>
        ...
        <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
            ...
            <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100"
                ...
                <div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20 p-8">
                    ...
                    @endif
                    <form method="POST" action="{{route('admin.pegawai.prosestambah')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex">
                            <x-label for="pria" class="flex p-2 cursor-pointer">
                                <input class="my-auto transform scale-125" type="radio" id="pria" name="gender" value="pria"/>
                                <div class="px-2">Pria</div>
                            </x-label>
                            <x-label for="wanita" class="flex p-2 cursor-pointer">
                                <input class="my-auto transform scale-125" type="radio" id="wanita" name="gender" value="wanita"/>
                        ...
                        <x-input id="title" type="text" name="title" :value="old('title')" placeholder="Masukkan Pekerjaan Anda" autocomplete="off"/>
                        ...
                        <p class="flex flex-col items-center justify-center mt-4 text-center text-lg text-gray-500 space-y-6 mb-6">
                            <input type="submit" class="w-full mt-6 bg-indigo-400 px-4 py-4 rounded-md text-white font-semibold shadow-md items-center hover:bg-indigo-600 transition duration-200"
                                value="Simpan"
                            >
        ...
        <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
            ...
            <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100"
                ...
                <div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20 p-8">
                    ...
                    @endif
                    <form id="formEdit" action="{{route('admin.pegawai.prosesedit')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex justify-between space-x-4">
                            ...
                            <div class="w-1/2 pr-4">
                                ...
                                <x-input id="editUsername" type="text" name="username" :value="old('username')" placeholder="Masukkan Username" autofocus autocomplete="off"/>
                                @if (Session::has('error_update.username'))
                                {{ Session::get('error_update.username')}}
                                <br>
                                @endif
                            ...
                            <div class="w-1/2">
                                ...
                                <x-input id="editNama" type="text" name="nama" :value="old('nama')" placeholder="Masukkan Nama Lengkap" autocomplete="off"/>
                                @if (Session::has('error_update.nama'))
                                        {{ Session::get('error_update.nama')}}
                                        <br>
                                @endif
                        ...
                        <x-input id="editNik" type="text" name="nik" :value="old('nik')" placeholder="Masukkan NIK" autocomplete="off"/>
                        ...
                        <div class="flex">
                            <x-label for="pria" class="flex p-2 cursor-pointer">
                                <input class="my-auto transform scale-125 editGender" type="radio" id="editPria" value="pria" name="gender"/>
                                <div class="px-2">Pria</div>
                            </x-label>
                            <x-label for="wanita" class="flex p-2 cursor-pointer">
                                <input class="my-auto transform scale-125 editGender" type="radio" id="editWanita" value="wanita" name="gender"/>
                                <div class="px-2">Wanita</div>
                            </x-label>
                        </div>
                        ...
                        <x-input id="editAgama" type="text" name="agama" :value="old('agama')" placeholder="Masukkan Agama Anda" autocomplete="off"/>
                        ...
                        <x-input id="editAlamat" type="text" name="alamat" :value="old('alamat')" placeholder="Masukkan Alamat Anda" autocomplete="off"/>
                        ...
                        <x-input class="appearance-none" id="editNotelp" type="number" name="notelp" :value="old('notelp')" placeholder="Masukkan Nomor Telepon Anda" autocomplete="off"/>
                        ...
                        <x-input id="editMulaiMasuk" type="date" name="mulaimasuk" :value="old('mulaimasuk')" autocomplete="off"/>
                        ...
                        <x-input id="editIjazah" type="text" name="ijazah" :value="old('ijazah')" placeholder="Masukkan Ijazah Anda" autocomplete="off"/>
                        ...
                        <x-input id="editPekerjaan" type="text" name="title" :value="old('title')" placeholder="Masukkan Pekerjaan Anda" autocomplete="off"/>
                        ...
                        <x-input id="editStatus_kepegawaian" type="text" name="status_kepegawaian" :value="old('status_kepegawaian')" placeholder="Masukkan Status Kepegawaian Anda" autocomplete="off"/>
                        ...
                        <x-input id="editPelatihan" type="text" name="pelatihan" :value="old('pelatihan')" placeholder="Masukkan Pelatihan Anda" autocomplete="off"/>
                        ...
                        <div class="flex">
                            <x-label for="active" class="flex p-2 cursor-pointer">
                                <input class="my-auto transform scale-125 editStatus" type="radio" value="1" id="editActive" name="status"/>
                                <div class="px-2">Active</div>
                            </x-label>
                            <x-label for="editInActive" class="flex p-2 cursor-pointer">
                                <input class="my-auto transform scale-125 editStatus" type="radio" value="0" id="editInActive" name="status"/>
                        ...
                        <x-label for="foto" :value="__('Foto')"/>
                        <div class="flex space-x-4 items-center">
                            <img id="editPreviewImg" src="https://user-images.githubusercontent.com/507615/54591670-ac0a0180-4a65-11e9-846c-e55ffce0fe7b.png" class="object-cover w-40 h-40 rounded-full shadow border-2 border-gray-300 border-dashed previewImg" alt="profile image">
                        ...
                        <p class="flex flex-col items-center justify-center mt-4 text-center text-lg text-gray-500 space-y-6 mb-6">
                            <button type="submit" id="editSubmit" class="w-full mt-6 bg-indigo-400 px-4 py-4 rounded-md text-white font-semibold shadow-md items-center hover:bg-indigo-600 transition duration-200">
                                Simpan
                            </button>
                            <button class="text-indigo-400 font-medium text-lg hover:text-indigo-900 transition duration-200"
            ...
            <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100"
                ...
                <div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20 p-8">
                    ...
                    <form>
                        ...
                        <x-input id="updatePassword" type="password" name="password" :value="old('password')" placeholder="Masukkan Password" autocomplete="off"/>
                        ...
                        <x-input id="updatePassword_confirmation" type="password" name="password_confirmation" :value="old('password_confirmation')" placeholder="Masukkan Ulang Password" autocomplete="off"/>
                        ...
                        <!-- Button Input -->
                        <p class="flex flex-col items-center justify-center mt-4 text-center text-lg text-gray-500 space-y-6 mb-6">
                            <button id="updatePasswordSubmit" class="w-full mt-6 bg-indigo-400 px-4 py-4 rounded-md text-white font-semibold shadow-md items-center hover:bg-indigo-600 transition duration-200">
                                Simpan
                            </button>
                            <button class="text-indigo-400 font-medium text-lg hover:text-indigo-900 transition duration-200"
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '#details', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        document.getElementById("detailUsername").innerHTML = data["0"]["username"];
                        document.getElementById("detailJenisKelamin").innerHTML = data["0"]["gender"];
                        ...
                        document.getElementById("detailTglLahir").innerHTML = data["0"]["tgl_lahir"];
            ...
            $(document).on('click', '#ubahPassword', function(){$('#updateIdPassword').val($(this).data('id'));});
            $(document).on('click', '#updatePasswordSubmit', function(){
                ...
                $.ajax({
                    ...
                    success:function(data){window.location.replace("{{route('admin.kepegawaian')}}");},
                    error: function(data){}
                });
            });
                    ...
                    success:function(data)
                    {
                        ...
                        $.each($role, function(){
                            if($role[$i]["id"] == $user['id_level']){
                                $('#editId_level').append("<option value='" + $role[$i]["id"] + "' selected>" + $role[$i]["keterangan"] + "</option> ");
                            }
                            else {
                                $('#editId_level').append("<option value='" + $role[$i]["id"] + "'>" + $role[$i]["keterangan"] + "</option> ");
                            }
                            $i+=1;
                        });
                        if($user["gender"] == "pria"){
                        ...
                        if($user['foto'] != null){
                            ...
                            $("#editPreviewImg").attr("src", "https://user-images.githubusercontent.com/507615/54591670-ac0a0180-4a65-11e9-846c-e55ffce0fe7b.png");
                        }
